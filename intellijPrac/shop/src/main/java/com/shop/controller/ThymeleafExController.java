...
public class ThymeleafExController {
    ...
    public String thymeleafEaxm03(Model model){
    ...
    public String thymeleafEaxm04(Model model){
        List<ItemDto> itemDtoList = new ArrayList<>();
        for(int i=1;i<=5;i++){
            ItemDto itemDto = new ItemDto();
            itemDto.setItemNm("더미 상품"+i);
    ...
    public String thymeleafEaxm05(){
        return "thymeleafEx/thymeleafEx05";
    }
    @GetMapping(value="/ex06")
    public String thymeleafEaxm06(String param1, String param2, Model model){
    ...
    public String thymeleafEaxm07(){
        return "thymeleafEx/thymeleafEx07";
    }

    @GetMapping(value="/ex08")
    public String thymeleafEaxm08(Model model){
